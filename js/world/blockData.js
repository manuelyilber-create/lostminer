...
export const BLOCK_PROPERTIES = {
    ...
    [BLOCKS.DIRT]: { name: "Tierra Orgánica", solid: true, color: "#543821", detailColor: "#3d2715" },
    [BLOCKS.GRASS]: { name: "Pasto Nutritivo", solid: true, color: "#427a24", topColor: "#57a62e" },
    [BLOCKS.STONE]: { name: "Piedra Rocosa", solid: true, color: "#4d5156", detailColor: "#383a3d", hardness: 3 },
    ...
    [BLOCKS.DIAMOND]: { name: "Mena de Diamante", solid: true, color: "#4d5156", spotColor: "#2be0d4", light: 0.2 },
    [BLOCKS.TORCH]: { name: "Antorcha Intensa", solid: false, light: 1.0, color: "#ff9900" }
};
